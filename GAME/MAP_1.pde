...
//Murs Droit
  ...
  if (((GAME_x_ennemi*height/300+translationX >= 1.1*width+translationX) || (GAME_x_ennemi+translationX >= (0.5*width+translationX)-32*height/300) && (GAME_x_ennemi+translationX <= (0.6*width+translationX)) && (GAME_y_ennemi+translationY <= 0.1*width+translationY)))  {  
